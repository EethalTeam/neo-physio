    ...
    <div className="space-y-6 ">
      ...
      >
        <Card className="medical-card hidden md:block">
          <CardHeader>
            ...
            <CardDescription>
              List of all defined transaction Lead status.
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <tbody>
                  {leadStatus.map((lead) => (
                    ...
                    >
                      ...
                      <td className="p-3">
                        <span
                          className={`px-2 py-1 text-xs font-medium rounded-full ${lead.isActive ? "bg-blue-100 text-blue-800" : "bg-gray-100 text-gray-800"}`}
                        >
      ...
      <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>
              {editingLeadStatus ? "Edit LeadStatus" : "Add New LeadStatus"}
            </DialogTitle>
            <DialogDescription>
              Define a new LeadStatus for tracking transactions.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleFormSubmit} className="space-y-6 pt-4">
            <div className="gap-10 grid grid-cols-2">
              <div>
                ...
                <Input
                  type="color"
                  id="leadStatusColor"
                  name="leadStatusColor"
                  value={leadStatusForm.leadStatusColor}
            ...
            <div className="space-y-2">
              ...
              <Input
                id="leadStatusCode"
                name="leadStatusCode"
                value={leadStatusForm.leadStatusCode}
                onChange={handleFormChange}
                required
            ...
            <div className="space-y-2">
              ...
              <Input
                id="leadStatusName"
                name="leadStatusName"
                value={leadStatusForm.leadStatusName}
                onChange={handleFormChange}
                required
            ...
            <DialogFooter>
              ...
              <Button type="submit">
                {editingLeadStatus ? "Save Changes" : "Add LeadStatus"}
              </Button>
            </DialogFooter>
          </form>
        </DialogContent>
