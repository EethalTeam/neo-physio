      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
            <Layers size={30} /> State{" "}
          </h1>
          <p className="text-gray-600 mt-1">
            Manage the list of State for session feedback.
          </p>
        </div>
        {Permissions.isAdd && (
          <Button
      ...
      >
        <Card className="medical-card">
          <CardHeader>
            ...
            <CardDescription>
              List of all defined transaction State.
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Define a new State for tracking transactions.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleFormSubmit} className="space-y-6 pt-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(v) =>
                  setStateForm((prev) => ({ ...prev, CountryId: v }))
                }
              ...
              >
                ...
                <SelectContent>
                  {countries.map((country) => (
                    <SelectItem
                      key={country.CountryIDPK}
                      value={country.CountryIDPK}
                    >
                      {country.countryName}
                    </SelectItem>
                  ))}
