    ...
    <div className="space-y-6">
      ...
      >
        <div>
          ...
          <p className="text-gray-600">
            Manage the list of review types for session feedback.
          </p>
        </div>
        {Permissions.isAdd && (
          <Button onClick={handleNew}>
            <PlusCircle className="mr-2 h-4 w-4" /> Add Review Type
          </Button>
        )}
      </motion.div>
        ...
        <Card className="medical-card">
          <CardHeader>
            ...
            <CardDescription className="">
              These types will appear in the session feedback form.
            </CardDescription>
          </CardHeader>
          <CardContent>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              ...
                              permanently delete the review type.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
                            ...
                            <AlertDialogAction
                              onClick={() =>
                                handleDelete(type.ReviewTypeIDPK || type._id)
                              }
                            >
                              Delete
                            </AlertDialogAction>
      ...
      <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {editingType ? "Edit Review Type" : "Add New Review Type"}
            </DialogTitle>
          </DialogHeader>
          <form onSubmit={handleFormSubmit} className="space-y-4 pt-4">
            <div className="space-y-2">
              ...
              <Input
                id="reviewTypeCode"
                name="reviewTypeCode"
                value={reviewTypeData.reviewTypeCode}
            ...
            <div className="space-y-2">
              ...
              <Input
                id="reviewTypeName"
                name="reviewTypeName"
                value={reviewTypeData.reviewTypeName}
                onChange={handleChangeReviewType}
                placeholder="e.g., Severe night pain"
                required
              />
            </div>
            <DialogFooter>
              ...
              <Button type="submit">
                {editingType ? "Save Changes" : "Add Review Type"}
              </Button>
            </DialogFooter>
          </form>
        </DialogContent>
