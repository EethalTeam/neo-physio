      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
            <Layers size={30} /> Country{" "}
          </h1>
          <p className="text-gray-600 mt-1">
            Manage the list of Country for session feedback.
          </p>
        </div>
        {Permissions.isAdd && (
          <Button
      ...
      >
        <Card className="medical-card">
          <CardHeader>
            ...
            <CardDescription>
              List of all defined transaction Country.
            </CardDescription>
          </CardHeader>
          <CardContent>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                  ...
                                  <AlertDialogAction
                                    onClick={() =>
                                      handleDelete(count.CountryIDPK)
                                    }
                                  >
                                    Delete
                                  </AlertDialogAction>
      ...
      <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Define a new Country for tracking transactions.
            </DialogDescription>
          </DialogHeader>
