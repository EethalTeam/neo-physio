      ...
      >
        <div>
          <h1 className="md:text-3xl text-2xl font-bold text-gray-900 flex items-center gap-3">
            <Layers size={30} /> Gender{" "}
          </h1>
          <p className="text-gray-600 mt-1">Manage All Gender.</p>
        </div>
        {Permissions.isAdd && (
          <Button
      ...
      >
        <Card className="medical-card">
          <CardHeader>
            ...
            <CardDescription>
              List of all defined transaction Gender.
            </CardDescription>
          </CardHeader>
          <CardContent>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    This will permanently delete the Gender.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                  <AlertDialogCancel>Cancel</AlertDialogCancel>
                                  <AlertDialogAction
                                    onClick={() => handleDelete(gen.GenderIDPK)}
                                  >
                                    Delete
                                  </AlertDialogAction>
                                </AlertDialogFooter>
        ...
        <DialogContent className="max-w-md">
          ...
          <form onSubmit={handleFormSubmit} className="space-y-6 pt-4">
            ...
            <DialogFooter>
              ...
              <Button type="submit">
                {editingGender ? "Save Changes" : "Add LeadSource"}
              </Button>
            </DialogFooter>
          </form>
        </DialogContent>
