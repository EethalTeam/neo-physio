...
const LeadSource = () => {
  ...
  const deleteLeadSource = async (id) => {
    try {
      ...
      toast({
        title: "Deleted",
        description: "LeadSource has been removed.",
        variant: "destructive",
      });
      getLeadSource();
      return response;
  ...
  const createLeadSource = async (data) => {
    try {
      ...
      toast({
        title: "Success",
        description: "LeadSource Create successfully.",
      });
      getLeadSource();
      setIsFormOpen(false);
      return response;
      ...
      >
        <Card className="medical-card">
          <CardHeader>
            ...
            <CardDescription>
              List of all defined transaction Lead Source.
            </CardDescription>
          </CardHeader>
          <CardContent>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                  ...
                                  <AlertDialogAction
                                    onClick={() =>
                                      handleDelete(leadSource.LeadIDPK)
                                    }
                                  >
                                    Delete
                                  </AlertDialogAction>
      ...
      <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Define a new Lead for tracking transactions.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleFormSubmit} className="space-y-6 pt-4">
            ...
            <DialogFooter>
              ...
              <Button type="submit">
                {editingLead ? "Save Changes" : "Add LeadSource"}
              </Button>
            </DialogFooter>
          </form>
        </DialogContent>
