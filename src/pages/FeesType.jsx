    ...
    <div className="space-y-6  ">
      ...
      >
        <Card className="medical-card hidden md:block">
          <CardHeader>
            ...
            <CardDescription>
              List of all defined transaction Fees Type.
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <tbody>
                  {FeesType.map((fees) => (
                    ...
                    >
                      ...
                      <td className="p-3">
                        <span
                          className={`px-2 py-1 text-xs font-medium rounded-full ${fees.isActive ? "bg-blue-100 text-blue-800" : "bg-gray-100 text-gray-800"}`}
                        >
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    This will permanently delete the Fees Type.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
        ...
        {/* //card for mobile */}
        {/* --- MOBILE VIEW (CARDS) --- */}
        <Card className="md:hidden max-w-md mx-auto shadow-sm border rounded-xl">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg font-semibold">
              Fees Type ({FeesType.length})
            </CardTitle>
          </CardHeader>
      ...
      <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>
              {editingFeesType ? "Edit FeesType" : "Add New FeesType"}
            </DialogTitle>
            <DialogDescription>
              Define a new FeesType for tracking transactions.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleFormSubmit} className="space-y-6 pt-4">
            <div className="space-y-2">
              ...
              <Input
                id="feesTypeCode"
                name="feesTypeCode"
                value={FeesTypeForm.feesTypeCode}
            ...
            <div className="space-y-2">
              ...
              <Input
                id="feesTypeName"
                name="feesTypeName"
                value={FeesTypeForm.feesTypeName}
                onChange={handleFormChange}
                required
                placeholder="e.g., PerMonth"
              />
            </div>
            ...
            <DialogFooter>
              ...
              <Button type="submit">
                {editingFeesType ? "Save Changes" : "Add FeesType"}
              </Button>
            </DialogFooter>
          </form>
        </DialogContent>
