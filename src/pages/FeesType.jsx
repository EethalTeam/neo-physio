    ...
    return (
        <div className="space-y-6  ">
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex flex-col md:flex-row md:justify-between items-start gap-4">
                <div>
                    <h1 className="md:text-3xl text-xl font-bold text-gray-900 flex items-center gap-3"><Layers size={30} /> Fees Type</h1>
                        ...
                        <div className="grid gap-3">
                            {FeesType.map((fees) => (
                                ...
                                >
                                    ...
                                    <div>
                                        <span
                                            className={`px-2 py-1 text-xs font-medium rounded-full ${fees.isActive
