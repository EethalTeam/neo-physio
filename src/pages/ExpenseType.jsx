    ...
    <div className="space-y-6  ">
      ...
      >
        <Card className="medical-card hidden md:block">
          <CardHeader>
            ...
            <CardDescription>
              List of all defined transaction Expense Type.
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <tbody>
                  {expenseType.map((expenses) => (
                    ...
                    >
                      ...
                      <td className="p-3">
                        <span
                          className={`px-2 py-1 text-xs font-medium rounded-full ${expenses.isActive ? "bg-blue-100 text-blue-800" : "bg-gray-100 text-gray-800"}`}
                        >
      ...
      <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>
              {editingExpenseType ? "Edit ExpenseType" : "Add New ExpenseType"}
            </DialogTitle>
            <DialogDescription>
              Define a new ExpenseType for tracking transactions.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleFormSubmit} className="space-y-6 pt-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                value={ExpenseTypeForm.ExpenseTypeCode}
                onChange={handleFormChange}
                required
                placeholder="e.g., ET001"
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                value={ExpenseTypeForm.ExpenseTypeName}
                onChange={handleFormChange}
                required
            ...
            <div className="space-y-3">
              ...
              <RadioGroup
                name="isActive"
                value={ExpenseTypeForm.isActive}
            ...
            <DialogFooter>
              ...
              <Button type="submit">
                {editingExpenseType ? "Save Changes" : "Add ExpenseType"}
              </Button>
            </DialogFooter>
          </form>
        </DialogContent>
